    ...
    return (
        <>
            <Toolbar className={classes.toolbar}>
                ...
                <Button><a href="https://github.com/zoe-pixel/ProvaReact.git" style={{ textDecoration: "none", color: "tomato", fontFamily: "Comic Sans MS" }} target="_blank">Repositório</a></Button>
            </Toolbar>
        </>
    );
}
